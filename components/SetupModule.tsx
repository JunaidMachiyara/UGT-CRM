...
type Entity = Customer | Supplier | Item | OriginalType | Division | Bank | LoanAccount | CapitalAccount | InvestmentAccount | CashAccount | ExpenseAccount | SubDivision | FreightForwarder | ClearingAgent | CommissionAgent | Employee | Section | Category | Vehicle | Warehouse;
...
interface CrudManagerProps<T extends Entity & { id: string, name?: string, fullName?: string, accountTitle?: string, plateNumber?: string }> {
    ...
    entityName: 'customers' | 'suppliers' | 'commissionAgents' | 'items' | 'originalTypes' | 'divisions' | 'subDivisions' | 'freightForwarders' | 'clearingAgents' | 'banks' | 'loanAccounts' | 'capitalAccounts' | 'investmentAccounts' | 'cashAccounts' | 'expenseAccounts' | 'employees' | 'sections' | 'categories' | 'vehicles' | 'warehouses';
